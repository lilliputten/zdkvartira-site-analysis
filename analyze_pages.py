...
def extract_page_info(html_path, base_url=None, base_dir=None):
    ...
    if base_dir is None:
        ...
        base_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'analyze', 'zdkvartira.ru')
...
def main():
    ...
    base_dir = os.path.join(script_dir, 'analyze', 'zdkvartira.ru')
    ...
    print(f"  Source directory: analyze/zdkvartira.ru")
