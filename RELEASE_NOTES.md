...
### Core Files
- [`analyze-pages.py`](file://d:\Work\Myhoster\260306-zdkvartira\00-crawled\analyze-pages.py): Core analysis engine improvements
  - Enhanced `generate_human_readable_title()` function
  - Added page title and realty card detection
  - Improved Markdown output logic

### Configuration
- [`package.json`](file://d:\Work\Myhoster\260306-zdkvartira\00-crawled\package.json): Version bump to 0.0.2
- [`CHANGELOG.md`](file://d:\Work\Myhoster\260306-zdkvartira\00-crawled\CHANGELOG.md): Detailed v0.0.2 release notes
- [`README.md`](file://d:\Work\Myhoster\260306-zdkvartira\00-crawled\README.md): Updated features section
